...
const generarAccessToken = (user) => {
        ...
        // segundo argumnento, la llave para encriptar / desencriptar
        // tercer argument, el tiempo que va a durar ese token
...
export const login = async (req, res) =>{
    ...
    try {
        ...
        // "$2b$10$/sByY51xk2nPUNlJV6myZ.4L4t/Fmo1F/PydDsqJXuqqplBgKeDn2
